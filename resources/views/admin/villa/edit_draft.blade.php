                                ...
                                <div class="card-body">
                                    <div id="all-image">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <strong>
                                                    <p style="color:crimson;">Image Format .jpg .jpeg dan .png</p>
                                                </strong>
                                                <strong>
                                                    <p style="color:crimson;">So that images are more optimal, compress files up to 300kb in size</p>
                                                </strong>
                                            </div>
                                        ...
                                        <div class="card border shadow-none overflow-hidden br-3 mb-4"
                                            ...
                                            <div class="text-muted" style="text-align: right;">
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-action-rates="{{ route('admin.villa.update_rate', $item->id) }}">Edit</button>
                                                @endcan
                                                @can('villa-delete')
