                    ...
                    <form action="" method="post" class="f1">
                        ...
                        <fieldset>
                            <div class="title-filed">
                                <h4>Villa</h4>
                                <p class="desc-field">Insert detail your villa</p>
                            </div>
                        ...
                        <fieldset>
                            <div class="title-filed">
                                <h4>Address Villa</h4>
                                <p class="desc-field">Insert detail address villa</p>
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                        ...
                        <fieldset>
                            <div class="title-filed">
                                <h4>Maps</h4>
                                <p class="desc-field">Insert your location villa</p>
                            </div>
                            <div id="map"></div>
                            <div class="form-group">
                        ...
                        <fieldset>
                            <div class="title-filed">
                                <h4>Facilities</h4>
                                <p class="desc-field">Insert detail your facilities villa</p>
                            </div>
                            <div class="kategori">
                                <div class="tile">
