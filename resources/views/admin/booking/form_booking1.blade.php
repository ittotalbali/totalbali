            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label>Villa</label>
                            <select name="villa_id" id="villa"
                                class="form-control @error('villa_id') is-invalid @enderror">
                                <option value=" "> -- Villa -- </option>
                                @if (@$edit_mode)
                                    @foreach ($villa as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $booking->villa_id == $item->id ? 'selected' : '' }}>
                                            {{ $item->title }}
                                        </option>
                                    @endforeach
                                @else
                        ...
                        <div class="form-group">
                            ...
                            <select name="rate_type" id="type"
                                ...
                                @if (@$edit_mode)
                                    <option value="base"{{ $booking->rate_type == 'base' ? 'selected' : '' }}>Base
                                    <option value="high"{{ $booking->rate_type == 'high' ? 'selected' : '' }}>High
                                    <option value="low"{{ $booking->rate_type == 'low' ? 'selected' : '' }}>Low
                                    @else
                                ...
                                {{-- <option value=" "> -- Rate -- </option>
                                    @if (@$edit_mode)
                                        @foreach ($rate as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $booking->rate_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    @else
