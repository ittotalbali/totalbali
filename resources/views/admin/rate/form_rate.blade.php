...
@section('page_content')
    <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-4">
        ...
        <form action="{{ @$edit_mode ? route('admin.rate.update', ['rate' => $rate->id]) : route('admin.rate.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control @error('type') is-invalid @enderror">
                                    ...
                                    <option value="low"{{ $rate->type == 'low' ? 'selected' : '' }}>Low
                                        ...
                                        <option value="low_season"{{ $rate->type == 'low_season' ? 'selected' : '' }}>Low_season
                                        ...
                                        <option value="low_season">Low_season
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('admin.rate.index') }}" class="btn btn-secondary submit">Batal</a>
